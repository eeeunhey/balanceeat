    ...
    <div className={styles.join_container}>
      ...
      <form className={styles.join_form} onSubmit={join}>
        <div>
          ...
          <input
            className={`${styles.join_input} ${
              errors.name ? styles.error_input : name ? styles.success_input : ""
            }`}
            type="text"
            value={name}
        ...
        <div>
          ...
          <input
            className={`${styles.join_input} ${
              errors.id ? styles.error_input : id ? styles.success_input : ""
            }`}
            type="text"
            value={id}
        ...
        <div>
          ...
          <input
            className={`${styles.join_input} ${
              errors.pw ? styles.error_input : pw ? styles.success_input : ""
            }`}
            type="password"
            value={pw}
        ...
        <button type="submit" className={styles.join_button} disabled={!name || !id || !pw}>
          가입
        </button>
      </form>
    </div>
